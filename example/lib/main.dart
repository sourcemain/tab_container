...
class _ExamplePageState extends State<ExamplePage> {
            ...
            children: [
              ...
              ValueListenableBuilder<int>(
                ...
                builder: (_, value, __) {
                  ...
                  return Text('current index $value');
                },
              ),
              const Spacer(),
              Expanded(
  ...
  List<Widget> _getChildren2() {
    return <Widget>[
      Image.network('https://images.unsplash.com/photo-1583121274602-3e2820c69888?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2670&q=80'),
      Image.network('https://images.unsplash.com/photo-1494905998402-395d579af36f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80'),
      Image.network('https://images.unsplash.com/photo-1552519507-da3b142c6e3d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80'),
    ];
  }
